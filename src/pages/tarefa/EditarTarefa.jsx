...
// Declaração do componente EditarTarefa, recebendo como props, do Componente ListarTarefa, os states handleCloseEditar, idTarefaSelecionada, tarefas, tarefa e setTarefas
            ...
            <Card sx={style}>
                ...
                <CardContent sx={{ width: '95%', maxWidth: '100%' }}>
                    ...
                    <Grid container spacing={2} mt={1}>
                        <Grid item xs={3}>
                            <FormControl>
                                <Input id="tarefa_inicio" type="date" aria-describedby="tarefa_inicio_helper_text" value={inicioTarefa} onChange={e => setInicioTarefa(e.target.value)} sx={{ color: 'rgba(0, 0, 0, 0.6)', fontWeight: 400, paddingLeft: '13px' }} />
                                <FormHelperText id="tarefa_inicio_helper_text">Início da Tarefa.</FormHelperText>
                            </FormControl>
                        </Grid>
                        <Grid item xs={3}>
                            <FormControl>
                                <Input id="tarefa_fim" type="date" aria-describedby="tarefa_fim_helper_text" value={fimTarefa} onChange={e => setFimTarefa(e.target.value)} sx={{ color: 'rgba(0, 0, 0, 0.6)', fontWeight: 400, paddingLeft: '13px' }} />
                        ...
                        <Grid item xs={3}>
                            <FormControl fullWidth>
                                ...
                                <Select id="tarefa_recurso" value={recursoTarefa} label="Recurso" onChange={handleRecurso} size="small" sx={{ color: 'rgba(0, 0, 0, 0.6)', fontWeight: 400 }}>
                        ...
                        <Grid item xs={3}>
                            <FormControl fullWidth>
                                ...
                                <Select id="tarefa_status" value={statusTarefa} label="Status" onChange={handleStatus} size="small" sx={{ color: 'rgba(0, 0, 0, 0.6)', fontWeight: 400 }}>
